...
linksys_e8450_installer() {
	...
	owrt_version="$(wget -q -O - ${OPENWRT_TARGET}/version.buildinfo)"
	OPENWRT_INITRD="openwrt-${OPENWRT_RELEASE}-${owrt_version}-mediatek-mt7622-linksys_e8450-ubi-initramfs-recovery.itb"
	OPENWRT_SYSUPGRADE="openwrt-${OPENWRT_RELEASE}-${owrt_version}-mediatek-mt7622-linksys_e8450-ubi-squashfs-sysupgrade.itb"
